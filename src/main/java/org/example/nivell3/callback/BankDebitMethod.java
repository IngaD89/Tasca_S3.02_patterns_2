...
public class BankDebitMethod extends Payment{
    ...
    public void execute() {
        ...
        BankDebitMethod debit = new BankDebitMethod(ownerName, cardNumber, expirationMonth, expirationYear, ccv);

        System.out.println("Se esta haciendo pago con targeta de debito " + debit);
    }
}
